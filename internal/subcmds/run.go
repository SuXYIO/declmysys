...
type RunOpts struct {
	...
	Positional struct {
		Procedure string `positional-arg-name:"procedure" description:"Specify the procedure to do" long-description:"Specify the procedures to do, e.g. decls.foobar. See procedure spec in docs"`
